...
class ReservaViewHolder extends RecyclerView.ViewHolder implements View.OnCreateContextMenuListener {
   private final TextView mReservaItemView;
    ...
    public void onCreateContextMenu(ContextMenu menu, View v,
        ...
        menu.add(Menu.NONE, Reservapad.DELETE_ID, Menu.NONE, R.string.menu_delete_reserva);
        menu.add(Menu.NONE, Reservapad.EDIT_ID, Menu.NONE, R.string.menu_edit_reserva);
