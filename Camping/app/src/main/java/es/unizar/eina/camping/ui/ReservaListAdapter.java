...
public class ReservaListAdapter extends ListAdapter<Parcela, ParcelaViewHolder> {
    ...
    public ReservaListAdapter(@NonNull DiffUtil.ItemCallback<Parcela> diffCallback) {
        super(diffCallback);
    }
